    ...
    return {
        ...
        execute: function() {
            Modal = (function () {
                ...
                Modal = __decorate([
                    // this is very importnant (to work this line: this.modalEl.modal('show')) - don't do this (becouse this owerride jQuery which was changed by bootstrap, included in main html-body template): let $ = require('../../../../../node_modules/jquery/dist/jquery.min.js');
                    core_1.Component({
                        selector: 'modal',
                        templateUrl: './app/common/modal.html',
                        styleUrls: ['./app/common/modal.css']
                    }), 
